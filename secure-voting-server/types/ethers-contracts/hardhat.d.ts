...
getContractFactory(name: 'SecureVoting', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.SecureVoting__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'SecureVoting', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.SecureVoting>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SecureVoting', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SecureVoting>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SecureVoting', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SecureVoting>
